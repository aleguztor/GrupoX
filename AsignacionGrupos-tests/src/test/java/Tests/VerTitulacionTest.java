...
import java.net.URL;
public class VerTitulacionTest {
  ...
  public void verTitulacion() {
    ...
    driver.findElement(By.cssSelector(".u-icon-8 > .u-svg-link")).click();
    driver.findElement(By.cssSelector(".ui-widget-content:nth-child(1) > td:nth-child(1)")).click();
    assertThat(driver.findElement(By.cssSelector(".ui-widget-content:nth-child(1) > td:nth-child(1)")).getText(), is("1041"));
  }
}
