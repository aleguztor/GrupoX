...
CREATE TABLE ENCUESTA (FECHA_ENVIO DATE NOT NULL, DOCUMENTOS LONGVARBINARY, TURNO_PREFERENTE VARCHAR, CURSOACAMBIAR VARCHAR, DAMEDNI VARCHAR, RAZONES VARCHAR, EXPEDIENTE_NUM_EXPEDIENTE BIGINT NOT NULL, PRIMARY KEY (FECHA_ENVIO, EXPEDIENTE_NUM_EXPEDIENTE))
