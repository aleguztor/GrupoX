...
import java.net.URL;
public class ImportacionDatosYListadosTest {
  ...
  public void importacionDatosYListados() {
    ...
    driver.findElement(By.cssSelector(".u-expanded-width-md:nth-child(1) use")).click();
    ...
    assertThat(driver.findElement(By.cssSelector(".ui-widget-content:nth-child(1) > td:nth-child(3)")).getText(), is("Enríquez"));
  }
}
