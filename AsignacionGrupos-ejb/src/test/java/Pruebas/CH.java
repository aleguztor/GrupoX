...
public class CH {
	...
	public void testCambioHorarioyGrupo() {
		...
		Grupo a = new Grupo((long) 15,"2º", "a","Mañana");
		Grupo b = new Grupo((long) 16,"1º", "b","Mañana");
		Grupo c = new Grupo((long) 17,"1º", "c","Tarde");
		List<Grupo> grupos= new ArrayList<>();
		grupos.add(a);
		grupos.add(b);
		grupos.add(c);
		al.setAlumno_Grupos(grupos);
		Grupo nuevo= new Grupo((long) 18,"1º", "a", "Mañana");
		try {
