...
CREATE TABLE ENCUESTACAMBIOHORARIO (DNI VARCHAR NOT NULL, DOCUMENTOS LONGVARBINARY, FECHA_ENVIO DATE NOT NULL, CURSOACAMBIAR VARCHAR NOT NULL, RAZONES VARCHAR, ALUMNO_ID BIGINT, PRIMARY KEY (DNI))
