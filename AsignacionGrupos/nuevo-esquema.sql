...
CREATE TABLE GRUPO (ID BIGINT NOT NULL, ASIGNAR VARCHAR, CURSO VARCHAR NOT NULL, INGLES VARCHAR, LETRA VARCHAR NOT NULL, PLAZAS BIGINT, PLAZASNUEVOINGRESO BIGINT, PLAZASREPETIDORES BIGINT, TURNO_MANYANA_TARDE VARCHAR NOT NULL, VISIBLE VARCHAR, GRUPO_ID BIGINT, TITULACION_CODIGO INTEGER, PRIMARY KEY (ID))
