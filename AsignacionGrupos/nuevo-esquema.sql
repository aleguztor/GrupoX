...
CREATE TABLE GRUPO (ID BIGINT NOT NULL, ASIGNAR VARCHAR, CURSO VARCHAR NOT NULL, INGLES VARCHAR, LETRA VARCHAR NOT NULL, PLAZAS BIGINT, TURNO_MANYANA_TARDE VARCHAR NOT NULL, VISIBLE VARCHAR, ALUMNO_ID BIGINT, GRUPO_ID BIGINT, TITULACION_CODIGO INTEGER, PRIMARY KEY (ID))
...
ALTER TABLE GRUPO ADD CONSTRAINT FK_GRUPO_ALUMNO_ID FOREIGN KEY (ALUMNO_ID) REFERENCES ALUMNO (ID)
